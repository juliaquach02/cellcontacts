...
#' @param endpoint The last time point of the live-cell imaging sequence as integer
#'
#' @return Data frame of pairs of tracked cell names and endpoint cells which have been matched to each other.
#' @export
#
#' @examples
match_to_endpoint_ROIs_varEndpoint <- function( endPointROIs, endpointROImap, tumorROImap, tumorROImap_center, tumorROImap_NamesToGrid, endPoint ){
  
  # Get tumor cell names and polygons at last time point of the movie
  
  time <- as.character( endPoint )
