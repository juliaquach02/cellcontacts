...
The R package (Version 1.0) was built with the R version 4.3.1 and is suitable for all operating systems with sufficient RAM to load all data sets. 
...
The package (version 1.0) was tested on a Windows 10 Pro Education operating system (Version 22H2) with a 13th Gen Intel(R) Core (TM) i9-13900KF 3.00 GHz processor and 192 GB RAM.
