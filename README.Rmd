...
### Matching track names to their frame number

### Putting data into hash maps

### Computing cell-cell distances

### Filtering for cell-cell contacts

### Export the results for visualization and validation
